...
export default function OrderDetailPage() {
  ...
  const initialOrder = MOCK_ORDERS.find((o) => o.id === orderIdParam) || MOCK_ORDERS[0];
  const [selectedOrder, setSelectedOrder] = useState<EscrowOrder>(initialOrder);
  ...
  // Fees calculations matching screenshot
