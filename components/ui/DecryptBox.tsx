...
export function DecryptBox({ username, passwordReal, email, securityKeys }: DecryptBoxProps) {
          ...
          <div className="space-y-2.5">
            ...
            <div className="flex items-center justify-between rounded-xl border border-border/80 bg-muted/20 p-3.5">
              <div>
                ...
                <span className="font-mono text-sm font-semibold text-foreground">{username}</span>
              </div>
              <button
                type="button"
            ...
            <div className="flex items-center justify-between rounded-xl border border-border/80 bg-muted/20 p-3.5">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  type="button"
                  onClick={() => handleCopy(passwordReal, 'pass')}
                  className="flex items-center gap-1.5 rounded-lg border border-border bg-card px-2.5 py-1 text-xs font-semibold text-foreground hover:border-brand/40 transition-colors"
                >
            ...
            <div className="flex items-center justify-between rounded-xl border border-border/80 bg-muted/20 p-3.5">
              <div>
                ...
                <span className="font-mono text-xs font-semibold text-foreground">{email}</span>
              </div>
              <button
                type="button"
            ...
            {securityKeys && (
              <div className="flex items-center justify-between rounded-xl border border-border/80 bg-muted/20 p-3.5">
                <div>
                  ...
                  <span className="font-mono text-xs font-bold text-amber-500">{securityKeys}</span>
                </div>
                <button
                  type="button"
                  onClick={() => handleCopy(securityKeys, 'sec')}
                  className="flex items-center gap-1.5 rounded-lg border border-border bg-card px-2.5 py-1 text-xs font-semibold text-foreground hover:border-brand/40 transition-colors"
                >
